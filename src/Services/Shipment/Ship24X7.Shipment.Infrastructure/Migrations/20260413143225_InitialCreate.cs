        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BaseRatePerKg = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ServiceRateId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ActualWeight = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    VolumetricWeight = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ChargeableWeight = table.Column<decimal>(type: "decimal(18,2)", precision: 18, scale: 2, nullable: false),
                    ...
                    OriginHubId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    DestinationHubId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Shipments_ServiceRates_ServiceRateId",
                        column: x => x.ServiceRateId,
                        principalTable: "ServiceRates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Pickups_ConfirmationNumber",
                table: "Pickups",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Shipments_ServiceRateId",
                table: "Shipments",
                column: "ServiceRateId");
